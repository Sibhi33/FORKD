  ...
  return (
    <Box sx={{ flexGrow: 1}}>
      <AppBar sx={{backgroundColor:'White'}} position='static'>
        <Toolbar>
          <Typography variant="h5" component="div" sx={{ flexGrow: 1,color:'#cc3c23',fontSize:'30px' }}>
          Ｆｏｒｋｄ．🍴
          </Typography>
            <div>
            <Badge color="warning" variant="dot">
              ...
              >
                ...
                <Link to='/booking'><MenuItem onClick={handleClose}><Button startIcon={<BookOnlineIcon/>}>Booking</Button></MenuItem></Link>
                {
